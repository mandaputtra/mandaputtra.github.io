...
{{< figure src="https://nvie.com/img/git-model@2x.png" alt="Ilustrasi sebuah git branch" position="center" caption="Ilustrasi sebuah git branch" captionPosition="center" >}}
